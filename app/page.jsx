...
export default function Home() {
  ...
  useEffect(() => {
    ...
    const fetchCryptoData = async () => {
      try {
        const exchanges = ['belo', 'lemoncash', 'ripio', 'buenbit', 'letsbit',]
...
//****************************************************************** */
  ...
  return (
    <main style={openSans.style} className='dark:bg-[#23232a] dark:text-[#ddd] '>
      <div className='max-w-[1140px] mx-auto md:px-8 px-4 '>
        <div className='flex flex-col'>
          ...
          <div className="text-center my-8">
            ...
            <div className="w-full mt-4 mb-8 text-md leading-normal opacity-70 font-medium">
          ...
          <section>
            ...
            <div>
              ...
              <div className='flex flex-col gap-y-4 justify-center items-center mt-12 pb-8'>
                ...
                <div className='flex gap-2 font-bold text-[12px] md:text-lg'>
                  <div 
        ...
        <div className='flex flex-wrap gap-12 justify-center md:justify-between items-center mt-16 pb-6 ' >
          <div>
            ...
            <p className="text-xs text-gray-500 dark:text-gray-300">Los valores son meramente informativos y <br /> se basan en la información provista por <br /> cada proveedor <Link href='https://criptoya.com/' className='text-[#a063f5]'>CriptoYa</Link> y <Link href='https://dolarsi.com/' className='text-[#a063f5]'>DolarSi</Link>.</p>
          </div>
