      ...
      <div className="flex justify-evenly mb-12 flex-wrap text-md gap-y-6 ">
        <div>
          ...
          <div className="py-3 px-8 bg-white dark:bg-[#131316] rounded-xl flex gap-2 ">
            <Image src={bestAskExchangeImg} alt="" width={24} height={24} className="rounded-full object-cover"/>
        ...
        <div>
          ...
          <div className="py-3 px-8 bg-white dark:bg-[#131316] rounded-xl flex gap-2 ">
            <Image src={bestBidExchangeImg} alt="" width={24} height={24} className="rounded-full object-cover" /> 
            <div className="flex gap-2">
          ...
          <table className="w-full table-auto text-center ">
                <thead className="font-medium ">
                  <tr className="text-[14px] md:text-[16px]">
                    <th scope="col" className=" font-medium pt-0 pb-3 text-slate-400 dark:text-slate-200 ">Exchange</th>
                    <th scope="col" className="font-medium pt-0 pb-3 text-slate-400 dark:text-slate-200 ">Comprá a</th>
                    <th scope="col" className=" font-medium pt-0 pb-3 text-slate-400 dark:text-slate-200 ">Vendé a</th>
                    <th scope="col" className=" font-medium pt-0 pb-3 text-slate-400 dark:text-slate-200 "></th>
                  </tr>
                </thead>
                <tbody>
                  {Object.entries(data).map(([exchange, exchangeData]) => (
                    <tr key={exchange} className="border-b border-[#f0eff5] dark:border-[#23232a] transition duration-300 ease-in-out hover:bg-[#f0eff5] dark:hover:bg-[#23232a] cursor-pointer">
                      <td className="p-4 whitespace-nowrap flex items-center gap-2 md:gap-4 text-sm md:text-md lg:text-lg ">
                        ...
                        />
                        <h3 className="pr-3 md:pr-0 font-semibold">{exchangeData.name}</h3>
                      </td>
                      <td className="p-4 whitespace-nowrap text-sm md:text-md lg:text-lg">${exchangeData.ask.toLocaleString('es-AR')}</td>
                      <td className="p-4 whitespace-nowrap text-sm md:text-md lg:text-lg">${exchangeData.bid.toLocaleString('es-AR')}</td>
                      <td className="p-4">
                        <Link href={exchangeData.link} target="_blank"><BsFillArrowUpRightSquareFill className="text-[#a063f5] text-xl" /></Link>
                      </td>
                    </tr>
                  ))}
                </tbody>
